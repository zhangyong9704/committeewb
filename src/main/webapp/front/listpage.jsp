    ...
    <div class="row main" style="background:url(${pageContext.request.contextPath }/front/img/main1.jpg) no-repeat;background-size:100%">    <!--1920*1245-->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="row" style="position: relative;top:-5px;z-index: 100">
                <div class="col-md-12 col-sm-12 col-xs-12 nav" style="background: url(${pageContext.request.contextPath }/front/img/navbg.png) no-repeat;background-size: 100%">
                    <!--<img src="img/navbg.png">    &lt;!&ndash;1920*73&ndash;&gt;-->
                    <div>
                        <ul>
