...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-8" data-genuitec-path="/committeewb/src/main/webapp/admin/interf.jsp">
  	<%
	 ...
	 %>
  	<h1 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-8" data-genuitec-path="/committeewb/src/main/webapp/admin/interf.jsp">后台管理系统接口</h1>
  	 <h4>登录</h4>
     ...
     <hr/>
  	...
  	查询网站设置信息
  	<hr/>
  	http://20.14.3.28:8080/committeewb/webInfo/updateWebInfo<br/>
  	修改网站设置信息<br/>
  	...
  	<h4>导航栏：</h4>
    http://20.14.3.28:8080/committeewb/nav/queryAllNavs <br>
    查询所有的导航栏
    <hr>
    http://20.14.3.28:8080/committeewb/nav/updateNav<br/>
    修改导航栏信息(参数:id(必要)、name、jumpLink、sort(显示顺序))
    <hr/>
    http://20.14.3.28:8080/committeewb/nav/insertNav<br/>
    添加导航信息(参数:name、jumpLink、sort(显示顺序))
   	<hr/>
   	http://20.14.3.28:8080/committeewb/nav/deleteNav<br/>
   	删除导航信息(参数:id(必要))
   	
   	
   	<h4>banner图：</h4>
   	http://20.14.3.28:8080/committeewb/banner/queryAllBanners<br/>
   	查询所有的banner图(参数：type=0)
   	<hr/>
   	http://20.14.3.28:8080/committeewb/banner/insertBanner<br/>
   	添加banner图<br/>
   	参数：name、picFile(上传的文件)、jumpLink、type=0<br/>
   	上传图片要求：1190*370
   	<hr/>
   	http://20.14.3.28:8080/committeewb/banner/updateBanner<br/>
   	修改banner图<br/>
   	参数：id、name、picFile(上传的文件)、jumpLink<br/>
   	上传图片要求：1190*370
   	<hr/>
   	http://20.14.3.28:8080/committeewb/banner/deleteBanner<br/>
   	删除banner图<br/>
   	参数：id
   	...
   	<h4>新闻类别：</h4>
   	http://20.14.3.28:8080/committeewb/newsType/queryAllNewsType<br/>
   	查询所有的新闻类别
   	
   	<h4>新闻：</h4>
   	http://20.14.3.28:8080/committeewb/news/queryPageNews<br/>
   	...
   	<hr/>
   	http://20.14.3.28:8080/committeewb/news/write<br/>
   	to写文章页面 <br/>
   	<hr/>
   	...
   	<hr/>
   	http://20.14.3.28:8080/committeewb/news/queryWatermark<br/>
   	查询水印照片配置<br/>
   	<hr/>
   	http://20.14.3.28:8080/committeewb/news/watermark<br/>
   	修改水印照片配置<br/>
   	参数：isWatermark、watermarkText、watermarkType、picFile（图片水印）
   	<hr/>
   	
   	<h4>轮播图：</h4>
   	http://20.14.3.28:8080/committeewb/rollImg/queryAllRollImg<br/>
   	查询所有的轮播图<br/>
   	<hr/>
   	...
   	<hr/>
   	http://20.14.3.28:8080/committeewb/rollImg/queryRollImgByNewsID(RESTful风格)<br/>
   	根据newsID查询rollImg<br/>
   	参数：newsID(必要,新闻ID)
   	<hr/>
   	
   	<h4>规章制度、工作标准、通讯录、风采录：</h4>
   	http://20.14.3.28:8080/committeewb/home/queryHome(RESTful风格)<br/>
   	查询规章制度、工作标准、通讯录、风采录<br/>
   	参数：id(规章制度-->风采录，依次为1、2、3、4)
   	<hr/>
   	http://20.14.3.28:8080/committeewb/home/updateHome(id:RESTful风格)<br/>
   	修改规章制度、工作标准、通讯录、风采录<br/>
   	参数：id(规章制度-->风采录，依次为1、2、3、4)、修改的字段
   	<hr/>
   	http://20.14.3.28:8080/committeewb/home/write<br/>
   	to写规章制度等页面 (homeWrite.jsp) <br/>
   	<hr/>
   	http://20.14.3.28:8080/committeewb/home/edit(RESTful风格)<br/>
   	编辑规章制度时，用户直接copy url并打开一个新的页面，返回前端该页面 <br/>
   	参数：id(规章制度等的id)(规章制度-->风采录，依次为1、2、3、4)
   	<hr/>
   	
   	<h4>生活大家谈</h4>
   	http://20.14.3.28:8080/committeewb/lifeChat/queryLifeChat<br/>
   	查询 生活大家谈<br/>
   	<hr/>
   	...
   	<hr/>
   	http://20.14.3.28:8080/committeewb/news/{newsTypeID}/{id}/query(Restful风格)<br/>
   	查询新闻，同时新闻访问量+1  <br/>
   	参数：id(新闻id)
   	<hr/>
   	http://20.14.3.28:8080/committeewb/home/1/query(Restful风格)<br/>
